...
function ReceiverWalletDrawerScreen(props) {
    ...
    const connectedWallets = (0, react_1.useSyncExternalStore)(index_js_2.connectionManager.connectedWallets.subscribe, index_js_2.connectionManager.connectedWallets.getValue);
