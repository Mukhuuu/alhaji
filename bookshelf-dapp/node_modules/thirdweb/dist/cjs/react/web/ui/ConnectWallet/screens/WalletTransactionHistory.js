...
function WalletTransactionHistory(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { scrollY: true, flex: "column", fullHeight: true, style: {
            ...
            paddingBottom: index_js_1.spacing.lg,
                    ...
                    flex: "1",
                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.CrossCircledIcon, { width: index_js_1.iconSize.xl, height: index_js_1.iconSize.xl }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { children: "No Transactions" })] })) : ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", flex: "column", gap: "xs", children: transactions.map((tx) => {
