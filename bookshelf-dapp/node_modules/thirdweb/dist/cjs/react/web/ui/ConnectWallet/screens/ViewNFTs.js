...
function ViewNFTs(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
            minHeight: "300px",
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: connectLocale.viewFunds.viewNFTs, onBack: props.onBack }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "sm", scrollY: true, style: {
                    maxHeight: "500px",
                }, children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: {
                            display: "grid",
                            ...
                            return result.isLoading || !result.data ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "160px", width: "160px" }, `${nftList[index]?.chain?.id}:${nftList[index]?.address}`)) : (result.data.map((nft) => ((0, jsx_runtime_1.jsx)(NftCard, { ...nft, client: props.client, chain: nft.chain, theme: props.theme }, `${nft.chain.id}:${nft.address}:${nft.id}`))));
