...
function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return ((0, jsx_runtime_1.jsx)(PostOnRampSwap_js_1.PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onViewPendingTx: props.onViewPendingTx, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, payer: props.payer }));
    }
