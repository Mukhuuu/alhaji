...
function TransactionsScreen(props) {
    ...
    if (selectedTx) {
        return ((0, jsx_runtime_1.jsx)(TxDetailsScreen_js_1.TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: () => setSelectedTx(null), payer: payer, isBuyForTx: false, isEmbed: false }));
    }
