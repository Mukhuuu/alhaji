...
function DetailsModal(props) {
    ...
    if (screen === "network-switcher") {
        ...
        if (props.supportedNFTs) {
            content = ((0, jsx_runtime_1.jsx)(ViewFunds_js_1.ViewFunds, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
                    setScreen("main");
                }, setScreen: setScreen, client: client, connectLocale: locale }));
        }
        else {
    ...
    // thirdweb pay
        ...
        content = ((0, jsx_runtime_1.jsx)(LazyBuyScreen_js_1.LazyBuyScreen, { title: "Buy", isEmbed: false, client: client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, onViewPendingTx: () => setScreen("transactions"), connectLocale: locale, payOptions: props.detailsModal?.payOptions || {}, theme: typeof props.theme === "string" ? props.theme : props.theme.type, onDone: closeModal, connectOptions: undefined, buyForTx: undefined }));
    }
