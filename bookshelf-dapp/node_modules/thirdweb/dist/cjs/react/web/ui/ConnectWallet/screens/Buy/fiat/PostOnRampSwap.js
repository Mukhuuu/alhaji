...
function PostOnRampSwap(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(SwapFlow_js_1.SwapFlow, { title: props.title, payer: props.payer, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, onViewPendingTx: props.onViewPendingTx, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
