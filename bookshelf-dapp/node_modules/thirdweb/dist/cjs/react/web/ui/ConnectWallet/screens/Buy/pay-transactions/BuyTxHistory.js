...
function PayTxHistoryScreen(props) {
    ...
    if (selectedTx) {
        return ((0, jsx_runtime_1.jsx)(TxDetailsScreen_js_1.TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, payer: payer }));
    }
...
function PayTxHistoryList(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, flex: "column", fullHeight: true, style: {
            ...
            maxHeight: "370px",
                            ...
                            minHeight: "250px",
                        }, children: (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "xl", color: "accentText" }) })), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
