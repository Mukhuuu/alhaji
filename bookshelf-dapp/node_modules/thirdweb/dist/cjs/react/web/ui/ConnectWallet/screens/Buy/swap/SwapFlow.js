...
function SwapFlow(props) {
    ...
    if (swapTxHash) {
        return ((0, jsx_runtime_1.jsx)(SwapStatusScreen_js_1.SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, onViewPendingTx: props.onViewPendingTx, swapTxHash: swapTxHash, client: props.client, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: quote }));
    }
