...
export function WalletTransactionHistory(props) {
    ...
    return (_jsx(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
            ...
            paddingBottom: spacing.lg,
                    ...
                    flex: "1",
                }, children: [_jsx(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), _jsx(Text, { children: "No Transactions" })] })) : (_jsx(Container, { animate: "fadein", flex: "column", gap: "xs", children: transactions.map((tx) => {
