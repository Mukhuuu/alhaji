...
export function PayTxHistoryScreen(props) {
    ...
    if (selectedTx) {
        return (_jsx(TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, payer: payer }));
    }
...
export function PayTxHistoryList(props) {
    ...
    return (_jsxs(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
            ...
            maxHeight: "370px",
                            ...
                            minHeight: "250px",
                        }, children: _jsx(Spinner, { size: "xl", color: "accentText" }) })), _jsx(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
                        ...
                        }) }), isLoading && txInfosToShow.length > 0 && (_jsxs(_Fragment, { children: [_jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), _jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), _jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] }))] }), _jsx(Container, { py: "lg", children: pagination && !hidePagination && (_jsxs("div", { style: {
                        display: "grid",
