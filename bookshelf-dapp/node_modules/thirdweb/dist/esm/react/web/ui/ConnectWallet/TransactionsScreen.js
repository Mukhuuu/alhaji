...
export function TransactionsScreen(props) {
    ...
    if (selectedTx) {
        return (_jsx(TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: () => setSelectedTx(null), payer: payer, isBuyForTx: false, isEmbed: false }));
    }
