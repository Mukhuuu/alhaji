...
export function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return (_jsx(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onViewPendingTx: props.onViewPendingTx, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, payer: props.payer }));
    }
