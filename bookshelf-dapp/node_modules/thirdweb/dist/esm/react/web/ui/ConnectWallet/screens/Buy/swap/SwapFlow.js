...
export function SwapFlow(props) {
    ...
    if (swapTxHash) {
        return (_jsx(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, onViewPendingTx: props.onViewPendingTx, swapTxHash: swapTxHash, client: props.client, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: quote }));
    }
