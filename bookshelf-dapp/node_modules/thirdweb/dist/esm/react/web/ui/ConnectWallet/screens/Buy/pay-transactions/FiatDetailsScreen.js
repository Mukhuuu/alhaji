...
export function FiatDetailsScreen(props) {
    ...
    if (hasTwoSteps) {
        ...
        return (_jsx(PostOnRampSwapFlow, { title: props.title, client: props.client, status: status, onBack: props.onBack, onViewPendingTx: props.onBack, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: {
